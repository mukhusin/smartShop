      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
                ...
                <li><a href="#" class="dropdown-item">Sales Report </a></li>
                <li><a href="#" class="dropdown-item">Purchases Report</a></li>
                <li><a href="#" class="dropdown-item">Stock Report</a></li>
                </ul>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-secondary">
              <div class="inner">
                <h3>150 <small>Tshs</small></h3>

                <p><?php echo date('M, Y') ?> Sales</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-primary">
              <div class="inner">
                ...
                <p><?php echo date('M, Y') ?> Purchases</p>
              </div>
              <div class="icon">
                <i class="ion ion-bag"></i>
              </div>
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <ul class="nav nav-pills ml-auto">
                    <li class="nav-item">
                      <a class="nav-link active" href="#sales-data" data-toggle="tab">Sales</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="#purchases-data" data-toggle="tab">Purchases</a>
                    </li>
                  </ul>
                </div>
              </div><!-- /.card-header -->
