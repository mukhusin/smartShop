            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <ul class="nav nav-pills ml-auto">
                    <li class="nav-item">
                      <a class="nav-link active" href="#retailsale-data" data-toggle="tab">Retail Sale</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="index.php" >Wholesale</a>
                    </li>
                  </ul>
                </div>
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="tab-content p-0">
                  <!-- Morris chart - Sales -->
                  <div class="chart tab-pane active" id="retailsale-data" >
                      <div class="row">
                              <div class="col-md-7">
                                  <table id="retailsale-data-table" class="table table-bordered table-hover">
                                          <thead>
                                              <tr>
                                                  <th>product name</th>
                                                  <th>quantity</th>  
                                                  ...
                                                  foreach($product->fetchStock() as $item){
                                                      ...
                                                      echo '
                                                          <tr>
                                                                ...
                                                                <td><b>'.$item['rsale_price'].'</b></td>
                                                                <td><b>'.$item['rdiscount'].'</b></td>
                                                                <td>';
                                                                        if ($item['quantity'] > 0) {
                                                                            echo '<button from="rsale" dataId = '.$item['id'].' productId = '.$item['product_id'].' title="Add to cart" class="btn btn-sm btn-success addTocartBtn"  >Add</button>';
                                                                        } else {
                              ...
                              <div class="col-md-5">
                                  ...
                                  <!-- <form id="saleRetail-form" action="../route/web.php" method="POST" class="cat-data"> -->
                                        <div class="cat-data"><?php $product->cartData('rsale') ?></div>
                                  <!-- </form> -->
                              </div>             
                          </div> 
                      </div>  
